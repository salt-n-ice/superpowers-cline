...
**Context:** If working in an isolated worktree, it should have been created via the `/using-git-worktrees.md` skill at execution time.
...
After writing the complete plan, look at the spec with fresh eyes and check the plan against it. This is a checklist you run yourself — not a subtask dispatch.
