...
1. **Create Failing Test Case**
   ...
   - Use the `/test-driven-development.md` skill for writing proper failing tests
...
These techniques are part of systematic debugging and available in `systematic-debugging/`:
...
**Related skills:**
- **/test-driven-development.md** - For creating failing test case (Phase 4, Step 1)
- **/verification-before-completion.md** - Verify fix worked before claiming success
